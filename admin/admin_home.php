<?php
 ...
 $student_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Student");
 $student_count = mysqli_fetch_assoc($student_query)['count'];

 $room_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Room");
 $room_count = mysqli_fetch_assoc($room_query)['count'];

 $hostel_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Hostel");
 $hostel_count = mysqli_fetch_assoc($hostel_query)['count'];

 $manager_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Hostel_Manager");
 $manager_count = mysqli_fetch_assoc($manager_query)['count'];
...
<section class="stats py-5">
	<div class="container py-md-5">
		...
		<div class="row stats-inner-w3pvt-agileinfo">
			...
			<div class="col-lg-3 col-md-6 stats_info counter_grid3">
				<div class="stats_info1">
					<i class="fas fa-user-tie"></i>
					<p class="counter"><?php echo $manager_count; ?></p>
					<h4>Managers</h4>
				</div>
			</div>
		</div>
