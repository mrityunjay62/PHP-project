<?php
 ...
 $student_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Student WHERE Hostel_id = '$hostel_id'");
 $student_count = mysqli_fetch_assoc($student_query)['count'];

 $room_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Room WHERE Hostel_id = '$hostel_id'");
 $room_count = mysqli_fetch_assoc($room_query)['count'];

 $allocated_room_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Room WHERE Hostel_id = '$hostel_id' AND Allocated = '1'");
 $allocated_room_count = mysqli_fetch_assoc($allocated_room_query)['count'];

 $application_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM Application WHERE Hostel_id = '$hostel_id' AND Application_status = '1'");
...
<section class="stats py-5">
	<div class="container py-md-5">
		<h3 class="heading text-capitalize mb-lg-5 mb-4">Manager Dashboard Stats</h3>
		<div class="row stats-inner-w3pvt-agileinfo">
			...
			<div class="col-lg-3 col-md-6 stats_info counter_grid1">
				<div class="stats_info1">
					...
					<p class="counter"><?php echo $room_count; ?></p>
					<h4>Total Rooms</h4>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 stats_info counter_grid">
				<div class="stats_info2">
					<i class="fas fa-home"></i>
					<p class="counter"><?php echo $allocated_room_count; ?></p>
			...
			<div class="col-lg-3 col-md-6 stats_info counter_grid1">
				<div class="stats_info2">
					...
					<p class="counter"><?php echo $application_count; ?></p>
